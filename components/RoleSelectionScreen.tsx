...
interface RoleSelectionScreenProps {
  ...
  onRolesChange: (newSelection: Set<Role>) => void;
}
...
const RoleSelectionScreen: React.FC<RoleSelectionScreenProps> = ({ 
  ...
  const allRoles = Object.values(Role).filter(role => role !== Role.TOWNSPEOPLE && role !== Role.VAMPIRE); // Townspeople & generic Vampire are not selectable
