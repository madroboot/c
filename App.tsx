...
import { Player, GamePhase, Role, NightAction, PlayerStatus, Screen } from './types';
import { NIGHT_ACTION_ORDER, VAMPIRE_ROLES } from './constants';
import { assignRoles, resolveNightActions, checkWinConditions, processPlayerDeaths } from './services/gameLogic';
...
const App: React.FC = () => {
    ...
    useEffect(() => {
        ...
        if (!foundNextPlayer) {
            ...
            // Reset Jester state here, after the night is resolved.
    ...
    if (screen === 'setup') {
        return <SetupScreen onContinue={handleGoToRoleSelect} initialPlayers={pendingPlayers} />;
    }
